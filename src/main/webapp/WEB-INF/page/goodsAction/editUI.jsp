...
<body>
	<form action="goodsAction_edit" method="post">
		<table width="50%" border="1" >
			<tr>
				<td>商品编号 :</td>
				<td><input type="text" name="id" value="${goods.id}" readonly="true" /></td>
			</tr>
			<tr>
				<td>商品名称 :</td>
			...
			<tr>
				<td>商品进价 :</td>
				<td><input type="text" name="putPrice" value="${goods.putPrice}"/></td>
			</tr>
			<tr>
				<td>商品卖价 :</td>
				<td><input type="text" name="outPrice" value="${goods.outPrice}"/></td>
			</tr>
			<tr>
				<td>商品描述 :</td>
			...
			<tr>
				<td colspan="2" >商品所属类别 : <br/> 
					...
					<c:forEach var="goodsCategories" items="${goodsCategoriesSet }">
						<input type="checkbox" name="goodsCategoriesIds" id="checkbox_name_${goodsCategories.id }" value="${goodsCategories.id}" checked="checked"/>${goodsCategories.name }
					</c:forEach>
					<br/>
			...
			<tr>
				<td colspan="2" >商品所属套餐 : <br/> 
					...
					<c:forEach var="goodsSetMeal" items="${goodsSetMealSet }">
						...
						<input type="checkbox" name="goodsSetMealIds" id="checkbox_name_${goodsSetMeal.id }" value="${goodsSetMeal.id}" checked="checked"/>${goodsSetMeal.name }
