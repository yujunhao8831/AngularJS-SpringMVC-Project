...
<body>
	<form action="goodsSetMealAction_edit" method="post">
		<table width="50%" border="1" >
			<tr>
				<td>套餐编号 :</td>
				<td><input type="text" name="id" value="${goodsSetMeal.id}" readonly="true" /></td>
			</tr>
			<tr>
				<td>名称 :</td>
				<td><input type="text" name="name" value="${goodsSetMeal.name}"/></td>
			</tr>
			<tr>
				<td>赠送照片 :</td>
				<td><input type="text" name="givePhotoNumber" value="${goodsSetMeal.givePhotoNumber}"/></td>
			</tr>
			<tr>
				<td>套餐价格 :</td>
				<td><input type="text" name="price" value="${goodsSetMeal.price}"/></td>
			</tr>
			<tr>
